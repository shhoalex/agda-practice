module Learning.Equality where

data _≡_ {A : Set} (x : A) : A → Set where
  -- Everything equals to itself
  refl : x ≡ x
...
-- Martin Löf Equality ⇔ Leibniz Equality
...
-- Generalised Version of Composition
